...
const App = () => {
  ...
  const generateEmbedCode = (): string => {
    ...
    const embedCode = `<iframe width="${width === '' ? 560 : width}" height="${height === '' ? 315 : height}" scrolling="no" frameBorder="no" allow="autoplay" src="${embedUrl}"><a href="https://womanitely.com" style="display:none;">>Womanitely.com</a></iframe>`;
